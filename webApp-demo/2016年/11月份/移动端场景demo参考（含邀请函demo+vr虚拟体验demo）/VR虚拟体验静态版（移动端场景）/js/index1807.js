...
index.home = (function() {
	...
	function gotoStage() {
		...
		window.setTimeout(function(){
			$img.eq(0).anim("zoomIn2");
		},100);
		window.setTimeout(function(){
			$img.eq(1).anim("fadeInUp2");
		},150);
		window.setTimeout(function(){
			$img.eq(2).anim("fadeInUp2");
		},350);
		
		
	}
	function clearStyle(i) {
		var element = $("#swiper-container").find(".swiper-slide1").eq(i).find(".setImg");
		...
		if (garyClass == "gray1") {
			...
			window.setTimeout(function(){
				$(element).eq(0).anim("zoomIn2");
			},100);
			window.setTimeout(function(){
				$(element).eq(1).anim("fadeInUp2");
			},150);
			window.setTimeout(function(){
				$(element).eq(2).anim("fadeInUp2");
			},300);
		}
		if (garyClass == "gray2") {
			window.setTimeout(function(){
				$(element).eq(0).anim("fadeInUp2");
			},100);
			window.setTimeout(function(){
				$(element).eq(1).anim("fadeInUp2");
			},300);
			...
			window.setTimeout(function(){
				$(element).eq(3).anim("fadeInUp2");
			},700);
			window.setTimeout(function(){
				$(element).eq(4).anim("fadeInUp2");
			},900);
			window.setTimeout(function(){
				$(element).eq(5).anim("fadeInUp2");
			},1100);
