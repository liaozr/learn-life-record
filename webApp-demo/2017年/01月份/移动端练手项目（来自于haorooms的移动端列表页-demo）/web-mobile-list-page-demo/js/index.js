                                ...
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        for (var i = pageStart; i < pageEnd; i++) {
                                            result += "<div class=\"flag flag-middle\"><div class=\"triangle-topleft\"></div><span class='triangle-wen'>"+ data.lists[i].icon_wen +"</span><div class=\"flag__item flag_img\"><div class=\"img-center\"><a href=" + data.lists[i].link + "><canvas data-src=" + data.lists[i].pic +"></canvas></a></div></div><div class=\"flag__item flag__item_body\"><div class=\"heading\"><a href=" + data.lists[i].link + ">" + data.lists[i].title + "</a></div><div class=\"p\">" + data.lists[i].date +
                                                "</div></div></div>";
...
// ----------------------------------------------------------------------------- 
                    // 点击返回
                    $(".search-return").on("click",'#closeGsearch',function(e){
                         // 这个是阻止冒泡
                         e.stopPropagation();
                         $(".Gsearch").hide();
                         $('.confirm').hide();
                    ...
                    $(".g-header .return").click(function(){
                         history.go(-1);
                    })// -----------------------------------------------------------------------------  
...
// ---------------------------------------------------------------------------------------------------
                    ...
                    function mohuSearchData(e){
                        ...
                        if($.trim(skeyword)!=""){
                            $.ajax({
                                url:"./js/more.json",//模糊搜索地址，结合后台数据的。
                                type:"post",
                                dataType:"json",
