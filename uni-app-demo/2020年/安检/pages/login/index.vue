<template>
	<view class="page">
		...
		<view class="input-box divider3">
			<image style="width: 10px;height: 15px;" src="../../static/icon_phone.png"></image>
		...
		<view class="input-box divider3" style="padding-top: 29px;">
			<image style="width: 12px;height:17px;" src="../../static/icon_lock.png"></image>
			<input v-model.trim="password" :password="isPassword" placeholder="请输入密码" placeholder-style="font-size:16px;color:color: #CACACA;" />
			<image @click="isPassword=!isPassword" style="width: 20px;height:12px;" src="../../static/icon_eye.png"></image>
		</view>
