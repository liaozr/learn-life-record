...
<head>
    ...
    <style>
        ...
        #main div.top {
            width: 100%;
            background: url(/yhWeb/Public/Admin/Images/Main/main_r2_c2.jpg) no-repeat 0 10px;
            padding: 0 0 0 15px;
            line-height: 35px;
            float: left
        }
        ...
        #main div.sec {
            width: 100%;
            background: url(/yhWeb/Public/Admin/Images/Main/main_r2_c2.jpg) no-repeat 0 15px;
            padding: 0 0 0 15px;
            line-height: 35px;
            float: left
        }
        ...
        div.main-tit {
            ...
            font-weight: bold;
            color: #4e4e4e;
            background: url(/yhWeb/Public/Admin/Images/Main/main_r4_c2.jpg) no-repeat 0 33px;
            width: 100%;
        ...
        div.main-corpy {
            ...
            font-weight: bold;
            color: #4e4e4e;
            background: url(/yhWeb/Public/Admin/Images/Main/main_r6_c2.jpg) no-repeat 0 33px;
            width: 100%;
            padding: 30px 0 0 20px;
            float: left
        }
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="main">
    <tr>
        <td colspan="2" align="left" valign="top">
            <span class="time"><strong>上午好！<?php echo (session('adminName')); ?></strong><u>[超级管理员]</u></span>
