...
export const getterlists = makeAction('GETTERSLISTS') 

export const getstartlist = makeAction('GETSTARTLIST') 

export const topiclistchange = makeAction('TOPICLISTCHANGE') 

export const initTopiclist = makeAction('INITTIPICLIST') 
