<template>
	<div class="login-container">
		...
		<div class="login-header">
			<a  v-link="{name:'login',activeClass:'active'}"  >&nbsp;&nbsp;&nbsp;&nbsp;登录&nbsp;&nbsp;&nbsp;&nbsp;·</a>
			<a  v-link="{name:'register',activeClass:'active'}" >&nbsp;&nbsp;&nbsp;&nbsp;注册&nbsp;&nbsp;&nbsp;&nbsp;</a>
		</div>

		<div class="login-input" v-if="$route.path=='/login'">
			<form class="form-horizontal" accept-charset="UTF-8" method="post">
				<div class="username">
					<span class="span1"><i class="fa fa-user"></i></span>
					<input type="text" name="sign_in[name]" placeholder="选一个昵称" class="span2">
				</div>
				<div class="password">
		...
		<div class="login-input" v-else>
		  <form class="form_register" accept-charset="UTF-8" method="post">
			    ...
			    <div class="email"> <span class="span1"><i class="fa fa-envelope-o"></i></span>
			      <input type="text" name="email_adress" placeholder="你的邮件地址" class="span2">
			    </div>

			    <div class="username"> <span class="span1"><i class="fa fa-user"></i></span>
			      <input type="text" name="sign_in[name]" placeholder="手机号码/电子邮件" class="span2">
			    </div>

			    <div class="password"> <span class="span1"><i class="fa fa-unlock-alt"></i></span>
			      <input type="password" name="sign_in[password]" placeholder="密码" class="span2">
			    </div>
