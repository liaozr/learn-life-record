...
console.log("msg from validate.js");
(function(t) {
  t.extend(t.fn, {
    validate: function(e) {
  ...
  t.extend(t.validator, {
    ...
    prototype: {
      init: function() {
        ...
        t(this.currentForm).validateDelegate(":text, [type='password'], [type='file'], select, textarea, [type='number'], [type='search'] ,[type='tel'], [type='url'], [type='email'],[type='mobile'],[type='tel'], [type='datetime'], [type='date'], [type='month'], [type='week'], [type='time'], [type='datetime-local'], [type='range'], [type='color'] ", "focusin focusout keyup", e).validateDelegate("[type='radio'], [type='checkbox'], select, option", "click", e),
    ...
    methods: {
      ...
      mobile: function(t, e) {
    	...
    	return this.optional(e) || (length == 11 && mobile.test(t));  	  
      },
      tel: function(t, e) {
      	var length = t.length;   
      	var tel = /^\d{3,4}-?\d{7,9}$/;
      	return this.optional(e) || (tel.test(t));  	  
      },
      url: function(t, e) {
