...
<script>
    ...
    import * as api_types from '@a/api'
    ...
    export default {
        ...
        methods:{
           ...
           gitlists(){
              ...
              var hetongcanshu={
                memId:'CK0001011707019'
              }
              var vuedata={}

               

              async function tongzhi_gonggao(){
                  return await eidpws_types.tongzhi_gonggao(tongzhigonggaocanshu)
                  
              }
              tongzhi_gonggao().then(function(res){
                  console.log("请求华美乐通知公告数据")
                  console.log(res)
              })

              async function hetongxinxi(){
                  return await eidpws_types.hetongxinxi(hetongcanshu)
                  
              }
              hetongxinxi().then(function(res){
                     console.log("合同信息接口请求成功233333")
                     console.log(res)
              })

            //   async function getmenus(){
            //       return await eidpws_types.getMenus(tongzhigonggaocanshu)
                  
            //   }
            //   getmenus().then(function(res){
            //          console.log("华美乐菜单获取成功")
            //          console.log(res)
            //   })
