...
export const mockdata = state => {
    return state.Userlist.mockdata
}

// 路由切换的transition 名字
export const routerChangeName = state => {
    return state.routerChange.transitionName
}

export const getloginState = state => {
    return state.globalState.loginState
}

export const getUserInfo = state => {
    return state.globalState.userInfo
}

export const getToken = state => {
    return state.globalState.token
}
