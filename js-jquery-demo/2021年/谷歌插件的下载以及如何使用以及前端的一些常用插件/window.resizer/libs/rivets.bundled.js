...
(function() {
  ...
  Rivets.View = (function() {
    ...
    View.prototype.traverse = function(node) {
      ...
      if (node !== this.els[0] || this.ignoreRoot !== true) {
  ...
  Rivets["public"].adapters['.'] = {
    ...
    observe: function(obj, keypath, callback) {
      var callbacks, desc, descriptor, value;
      ...
      if (callbacks[keypath] == null) {
        ...
        if (!((desc != null ? desc.get : void 0) || (desc != null ? desc.set : void 0))) {
          value = obj[keypath];
          descriptor = Object.getOwnPropertyDescriptor(obj.constructor.prototype, keypath);
          Object.defineProperty(obj, keypath, {
            ...
            set: (function(_this) {
              return function(newValue) {
                ...
                if (descriptor != null ? descriptor.set : void 0) {
                  descriptor.set.call(obj, newValue);
                }
                if (newValue !== value) {
