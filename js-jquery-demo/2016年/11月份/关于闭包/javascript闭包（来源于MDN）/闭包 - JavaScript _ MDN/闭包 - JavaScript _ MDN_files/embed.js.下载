(function() {
  ...
  Embed = (function(superClass) {
    ...
    Embed.prototype.loadResult = function(callback) {
      ...
      if (callback) {
        return resultsFrame.addEventListener("load", callback.apply([this]));
      }
    };
    ...
    Embed.prototype.switchTab = function(event, action, index) {
      ...
      if (action.dataset.triggerType === "result") {
        return this.loadResult((function(_this) {
          return function() {
            return _this.setHeight(_this.elements.tabs[index]);
          };
        })(this));
      }
    };
